...
function renderToggler () {
  if (!document.getElementById("toggle-forecast")) {
    ...
    forecastToggler.innerText = "Toggle Forecast";
...
async function getCity (location) {
  ...
  fetch(`http://api.openweathermap.org/geo/1.0/reverse?lat=${lat}&lon=${lon}&limit=5&appid=2721941ff1d23996817409883d4be5dd`)
    .then(async res => {
